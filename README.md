...
Вы можете ознакомиться с API и протестировать его методы, посетив следующий URL: "http://localhost: (порт, на котором работает микросервис) /swagger-ui/".
